...
declare const TextBase: Constructor<NativeMethodsMixinType> &
...
declare const TextInputBase: Constructor<NativeMethodsMixinType> &
 ...
 */
declare class ToolbarAndroidComponent extends React.Component<
  ToolbarAndroidProps
> {}
declare const ToolbarAndroidBase: Constructor<NativeMethodsMixinType> &
...
export interface ViewProps
   ...
   * we opt to not include pointerEvents on style. On some platforms, we would need to implement it as a styleName anyways. Using style or not is an implementation detail of the platform.
   */
...
declare const ViewBase: Constructor<NativeMethodsMixinType> &
...
declare class ViewPagerAndroidComponent extends React.Component<
  ViewPagerAndroidProps
> {}
declare const ViewPagerAndroidBase: Constructor<NativeMethodsMixinType> &
 ...
 */
declare class KeyboardAvoidingViewComponent extends React.Component<
...
declare const SafeAreaViewBase: Constructor<NativeMethodsMixinType> &
 ...
 */
export class InputAccessoryView extends React.Component<
...
> {}
declare const SegmentedControlIOSBase: Constructor<NativeMethodsMixinType> &
...
declare class ActivityIndicatorComponent extends React.Component<
  ActivityIndicatorProps
> {}
declare const ActivityIndicatorBase: Constructor<NativeMethodsMixinType> &
...
declare class DatePickerIOSComponent extends React.Component<
  DatePickerIOSProps
> {}
declare const DatePickerIOSBase: Constructor<NativeMethodsMixinType> &
...
declare class DrawerLayoutAndroidComponent extends React.Component<
  DrawerLayoutAndroidProps
> {}
declare const DrawerLayoutAndroidBase: Constructor<NativeMethodsMixinType> &
...
declare const PickerIOSBase: Constructor<NativeMethodsMixinType> &
  typeof PickerIOSComponent;
/**
 ...
 */
declare class ProgressBarAndroidComponent extends React.Component<
  ProgressBarAndroidProps
> {}
declare const ProgressBarAndroidBase: Constructor<NativeMethodsMixinType> &
...
declare class ProgressViewIOSComponent extends React.Component<
  ProgressViewIOSProps
> {}
declare const ProgressViewIOSBase: Constructor<NativeMethodsMixinType> &
 ...
 */
declare class RefreshControlComponent extends React.Component<
  RefreshControlProps
> {}
declare const RefreshControlBase: Constructor<NativeMethodsMixinType> &
 ...
 */
declare class RecyclerViewBackedScrollViewComponent extends React.Component<
  RecyclerViewBackedScrollViewProps
> {}
declare const RecyclerViewBackedScrollViewBase: Constructor<
...
declare const SliderBase: Constructor<NativeMethodsMixinType> &
...
declare const ImageBase: Constructor<NativeMethodsMixinType> &
...
declare class ImageBackgroundComponent extends React.Component<
  ImageBackgroundProps
> {}
declare const ImageBackgroundBase: Constructor<NativeMethodsMixinType> &
...
export type SectionListRenderItem<ItemT> = (
...
export class SectionList<SectionT = any> extends React.Component<
...
export interface SectionListStatic<SectionT>
  extends React.ComponentClass<SectionListProps<SectionT>> {
  /**
   * Scrolls to the item at the specified sectionIndex and itemIndex (within the section)
   * positioned in the viewable area such that viewPosition 0 places it at the top
   * (and may be covered by a sticky header), 1 at the bottom, and 0.5 centered in the middle.
...
declare const MaskedViewBase: Constructor<NativeMethodsMixinType> &
 ...
 */
declare class TouchableWithoutFeedbackComponent extends React.Component<
 ...
 */
declare class TouchableHighlightComponent extends React.Component<
 ...
 */
declare class TouchableNativeFeedbackComponent extends React.Component<
...
declare class SnapshotViewIOSComponent extends React.Component<
  SnapshotViewIOSProps
> {}
declare const SnapshotViewIOSBase: Constructor<NativeMethodsMixinType> &
...
declare const SwitchBase: Constructor<NativeMethodsMixinType> &
